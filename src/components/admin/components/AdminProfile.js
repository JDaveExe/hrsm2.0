      ...
      <Row>
        ...
        <Col lg={6} className="mb-4">
          <Card className="admin-profile-card">
            <Card.Header className="admin-profile-card-header">
              ...
              <Form>
                ...
                <div className="admin-profile-info-section">
                  <div className="admin-profile-info-item">
                    ...
                    <Badge bg="primary" className="admin-profile-badge">{profile?.role?.toUpperCase()}</Badge>
                  </div>
                  <div className="admin-profile-info-item">
                    <span className="label">Status:</span>
                    <Badge bg={profile?.isActive ? 'success' : 'danger'} className="admin-profile-badge">
        ...
        <Col lg={6} className="mb-4">
          <Card className="admin-profile-card">
            ...
            <Card.Body>
              {activitiesLoading ? (
                <div className="admin-profile-activities-loading">
                  <Spinner animation="border" size="sm" variant="primary" />
                  <span className="ms-2">Loading activities...</span>
                </div>
              ) : activities.length === 0 ? (
                <div className="admin-profile-no-activities">
                ...
                <>
                      ...
                      <div key={activity.id} className="admin-profile-activity-item">
                        ...
                        <div className="admin-profile-activity-content">
                          <div className="admin-profile-activity-header">
                            <span className="admin-profile-activity-action">
                          ...
                          <p className="admin-profile-activity-description">
                            {activity.actionDescription || activity.description || 'No description available'}
                          </p>
                          {activity.targetType && (
                            <div className="admin-profile-activity-meta">
                  ...
                  {activitiesTotal > 10 && (
                    <div className="admin-profile-activities-pagination">
                      <Button
                        variant="outline-primary"
                        size="sm"
                      ...
                      <span className="admin-profile-page-info">
